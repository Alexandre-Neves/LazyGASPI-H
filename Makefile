...
HEADERNAMES = lazygaspi_h.h
DEPS = include/lazygaspi_h.h src/gaspi_utils.h src/utils.h
OBJS = bin/init.o bin/general.o bin/read.o bin/write.o
OUTPUT_FILE_FORMAT=lazygaspi_h_*.out
